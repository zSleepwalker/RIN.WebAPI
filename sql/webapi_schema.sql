...
--
-- Name: AddMailAttachment(bigint, integer, bigint, integer); Type: FUNCTION; Schema: webapi; Owner: tmwadmin
--

CREATE FUNCTION webapi."AddMailAttachment"(p_message_id bigint, p_item_sdb_id integer, p_item_guid bigint DEFAULT NULL::bigint, p_quantity integer DEFAULT 1) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION webapi."AddMailAttachment"(p_message_id bigint, p_item_sdb_id integer, p_item_guid bigint, p_quantity integer) OWNER TO tmwadmin;
...
--
-- Name: ProcessCharacterDeletionQueue(); Type: FUNCTION; Schema: webapi; Owner: tmwadmin
--

CREATE FUNCTION webapi."ProcessCharacterDeletionQueue"() RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_char_guid bigint;
...
ALTER FUNCTION webapi."ProcessCharacterDeletionQueue"() OWNER TO tmwadmin;

--
-- Name: SendMail(bigint, bigint, text, text, text, text); Type: FUNCTION; Schema: webapi; Owner: tmwadmin
--

CREATE FUNCTION webapi."SendMail"(p_character_guid bigint, p_sender_guid bigint, p_sender_name text, p_subject text, p_body text, p_mail_type text DEFAULT 'system_message'::text) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_mail_id bigint;
...
ALTER FUNCTION webapi."SendMail"(p_character_guid bigint, p_sender_guid bigint, p_sender_name text, p_subject text, p_body text, p_mail_type text) OWNER TO tmwadmin;
...
--
-- Name: CharacterBoosts; Type: TABLE; Schema: webapi; Owner: tmwadmin
--

CREATE TABLE webapi."CharacterBoosts" (
    character_guid bigint NOT NULL,
...
ALTER TABLE webapi."CharacterBoosts" OWNER TO tmwadmin;
...
--
-- Name: CharacterLoadoutItems; Type: TABLE; Schema: webapi; Owner: tmwadmin
--

CREATE TABLE webapi."CharacterLoadoutItems" (
    character_guid bigint NOT NULL,
...
ALTER TABLE webapi."CharacterLoadoutItems" OWNER TO tmwadmin;

--
-- Name: CharacterLoadouts; Type: TABLE; Schema: webapi; Owner: tmwadmin
--

CREATE TABLE webapi."CharacterLoadouts" (
    character_guid bigint NOT NULL,
    loadout_id integer NOT NULL,
    battleframe_sdb_id integer NOT NULL,
...
--
-- Name: CharacterUnlocks; Type: TABLE; Schema: webapi; Owner: tmwadmin
--

CREATE TABLE webapi."CharacterUnlocks" (
    character_guid bigint NOT NULL,
...
ALTER TABLE webapi."CharacterUnlocks" OWNER TO tmwadmin;
...
--
-- Name: MailAttachments; Type: TABLE; Schema: webapi; Owner: tmwadmin
--
...
ALTER TABLE webapi."MailAttachments" OWNER TO tmwadmin;

--
-- Name: MailAttachments_id_seq; Type: SEQUENCE; Schema: webapi; Owner: tmwadmin
--

CREATE SEQUENCE webapi."MailAttachments_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE webapi."MailAttachments_id_seq" OWNER TO tmwadmin;

--
-- Name: MailAttachments_id_seq; Type: SEQUENCE OWNED BY; Schema: webapi; Owner: tmwadmin
--

ALTER SEQUENCE webapi."MailAttachments_id_seq" OWNED BY webapi."MailAttachments".id;


--
-- Name: MailMessages; Type: TABLE; Schema: webapi; Owner: tmwadmin
--

CREATE TABLE webapi."MailMessages" (
    id bigint NOT NULL,
    character_guid bigint NOT NULL,
    sender_guid bigint DEFAULT 0 NOT NULL,
    sender_name text NOT NULL,
    subject text NOT NULL,
    body text NOT NULL,
    is_read boolean DEFAULT false NOT NULL,
    mail_type text DEFAULT 'system_message'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    expires_at timestamp with time zone
);


ALTER TABLE webapi."MailMessages" OWNER TO tmwadmin;

--
-- Name: MailMessages_id_seq; Type: SEQUENCE; Schema: webapi; Owner: tmwadmin
--

CREATE SEQUENCE webapi."MailMessages_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE webapi."MailMessages_id_seq" OWNER TO tmwadmin;

--
-- Name: MailMessages_id_seq; Type: SEQUENCE OWNED BY; Schema: webapi; Owner: tmwadmin
--

ALTER SEQUENCE webapi."MailMessages_id_seq" OWNED BY webapi."MailMessages".id;
...
--
-- Name: MailAttachments id; Type: DEFAULT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."MailAttachments" ALTER COLUMN id SET DEFAULT nextval('webapi."MailAttachments_id_seq"'::regclass);


--
-- Name: MailMessages id; Type: DEFAULT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."MailMessages" ALTER COLUMN id SET DEFAULT nextval('webapi."MailMessages_id_seq"'::regclass);
...
--
-- Name: CharacterBoosts CharacterBoosts_pkey; Type: CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."CharacterBoosts"
    ADD CONSTRAINT "CharacterBoosts_pkey" PRIMARY KEY (character_guid, boost_type);


--
-- Name: CharacterItems CharacterItems_pkey; Type: CONSTRAINT; Schema: webapi; Owner: tmwadmin
--
...
--
-- Name: CharacterLoadoutItems CharacterLoadoutItems_item_guid_key; Type: CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."CharacterLoadoutItems"
    ADD CONSTRAINT "CharacterLoadoutItems_item_guid_key" UNIQUE (item_guid);


--
-- Name: CharacterLoadoutItems CharacterLoadoutItems_pkey; Type: CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."CharacterLoadoutItems"
    ADD CONSTRAINT "CharacterLoadoutItems_pkey" PRIMARY KEY (character_guid, loadout_id, slot_type);


--
-- Name: CharacterLoadouts CharacterLoadouts_pkey; Type: CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."CharacterLoadouts"
    ADD CONSTRAINT "CharacterLoadouts_pkey" PRIMARY KEY (character_guid, loadout_id);


--
-- Name: CharacterResources CharacterResources_pkey; Type: CONSTRAINT; Schema: webapi; Owner: tmwadmin
--
...
--
-- Name: CharacterUnlocks CharacterUnlocks_pkey; Type: CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."CharacterUnlocks"
    ADD CONSTRAINT "CharacterUnlocks_pkey" PRIMARY KEY (character_guid, unlock_type, unlock_id, frame_id);
...
--
-- Name: MailAttachments MailAttachments_pkey; Type: CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."MailAttachments"
    ADD CONSTRAINT "MailAttachments_pkey" PRIMARY KEY (id);


--
-- Name: MailMessages MailMessages_pkey; Type: CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."MailMessages"
    ADD CONSTRAINT "MailMessages_pkey" PRIMARY KEY (id);
...
--
-- Name: idx_character_boosts_expiration; Type: INDEX; Schema: webapi; Owner: tmwadmin
--

CREATE INDEX idx_character_boosts_expiration ON webapi."CharacterBoosts" USING btree (expiration_date);


--
-- Name: idx_character_loadout_items_character; Type: INDEX; Schema: webapi; Owner: tmwadmin
--

CREATE INDEX idx_character_loadout_items_character ON webapi."CharacterLoadoutItems" USING btree (character_guid);


--
-- Name: idx_character_loadout_items_loadout; Type: INDEX; Schema: webapi; Owner: tmwadmin
--

CREATE INDEX idx_character_loadout_items_loadout ON webapi."CharacterLoadoutItems" USING btree (character_guid, loadout_id);


--
-- Name: idx_character_unlocks_character; Type: INDEX; Schema: webapi; Owner: tmwadmin
--

CREATE INDEX idx_character_unlocks_character ON webapi."CharacterUnlocks" USING btree (character_guid);
...
--
-- Name: mailattachments_message_id_idx; Type: INDEX; Schema: webapi; Owner: tmwadmin
--

CREATE INDEX mailattachments_message_id_idx ON webapi."MailAttachments" USING btree (message_id);


--
-- Name: mailmessages_character_guid_idx; Type: INDEX; Schema: webapi; Owner: tmwadmin
--

CREATE INDEX mailmessages_character_guid_idx ON webapi."MailMessages" USING btree (character_guid);
...
--
-- Name: CharacterItems CharacterItems_character_guid_fkey; Type: FK CONSTRAINT; Schema: webapi; Owner: tmwadmin
--
...
--
-- Name: CharacterResources CharacterResources_character_guid_fkey; Type: FK CONSTRAINT; Schema: webapi; Owner: tmwadmin
--
...
--
-- Name: CharacterUnlocks CharacterUnlocks_character_guid_fkey; Type: FK CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."CharacterUnlocks"
    ADD CONSTRAINT "CharacterUnlocks_character_guid_fkey" FOREIGN KEY (character_guid) REFERENCES webapi."Characters"(character_guid) ON DELETE CASCADE;
...
--
-- Name: MailAttachments MailAttachments_message_id_fkey; Type: FK CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."MailAttachments"
    ADD CONSTRAINT "MailAttachments_message_id_fkey" FOREIGN KEY (message_id) REFERENCES webapi."MailMessages"(id) ON DELETE CASCADE;


--
-- Name: MailMessages MailMessages_character_guid_fkey; Type: FK CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."MailMessages"
    ADD CONSTRAINT "MailMessages_character_guid_fkey" FOREIGN KEY (character_guid) REFERENCES webapi."Characters"(character_guid) ON DELETE CASCADE;
...
--
-- Name: CharacterLoadouts character_loadouts_character_guid_fkey; Type: FK CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."CharacterLoadouts"
    ADD CONSTRAINT character_loadouts_character_guid_fkey FOREIGN KEY (character_guid) REFERENCES webapi."Characters"(character_guid) ON DELETE CASCADE;


--
-- Name: CharacterLoadoutItems fk_character_loadout_items_character; Type: FK CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."CharacterLoadoutItems"
    ADD CONSTRAINT fk_character_loadout_items_character FOREIGN KEY (character_guid) REFERENCES webapi."Characters"(character_guid) ON DELETE CASCADE;


--
-- Name: CharacterLoadoutItems fk_character_loadout_items_loadout; Type: FK CONSTRAINT; Schema: webapi; Owner: tmwadmin
--

ALTER TABLE ONLY webapi."CharacterLoadoutItems"
    ADD CONSTRAINT fk_character_loadout_items_loadout FOREIGN KEY (character_guid, loadout_id) REFERENCES webapi."CharacterLoadouts"(character_guid, loadout_id) ON DELETE CASCADE;
